...
export default function Home() {
  ...
  return (
    <div className="flex items-center justify-center bg-background font-sans">
      <main className="container mx-auto flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 space-y-8">
          <h1 className="text-3xl font-bold">Welcome to To-Do App</h1>
